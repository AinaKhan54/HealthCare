...
const DepartmentCard: React.FC<DepartmentCardProps> = ({ departments }) => {
  return (
    <div className="border rounded-lg shadow-md p-4 bg-white flex flex-col justify-between hover:shadow-lg transition-shadow duration-300 w-full sm:w-2/3 md:w-2/5 lg:w-4/6"> {/* Adjust width here */}
